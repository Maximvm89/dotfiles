    ...
    local opts = {
      ...
      config = {
        ...
        center = {
          ...
          { action = 'lua require("fzf-lua").files()',                                                desc = " Find Text",       icon = " ", key = "g" },
          { action = 'lua require("fzf-lua").files({cwd = "/net/code/workspaces/mparisi/git"})',      desc = " Git Find Text",   icon = " ", key = "t" },
